    ...
    return [
      TextButton(
        ...
        child: _getTitleItemWidget(
            'Serial${sortType == sortName ? (isAscending ? '  ↓' : '  ↑') : ''}',
            120,
            Colors.blue),
        onPressed: () {
          sortType = sortName;
      ...
      _getTitleItemWidget('Total', 100, Colors.blue),
      Container(
        width: 2,
        height: 56,
        color: Colors.white,
...
class StudentInfo {
  ...
  StudentInfo(
      this.name, this.status, this.roolNum, this.startTime, this.endTime);
}
